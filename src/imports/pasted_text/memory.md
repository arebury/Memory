...
- 8 commits de trabajo en esta sesión: `5a4299e` (logica casos+tono) · `7d151b6` (COA v1/v2) · `d900889` (honesty coste→volumen) · `ca52bee` (filter panel) · `271174e` (pipeline+chips) · `7db4619` (bulk hint) · `ce74c7e` (logica caveat+filtros) · `19fbf50` (COA digerible). Más `1cf56ee` (este canon close + decisiones.md mirror).
