...
- Cuatro commits en esta sesión: `e2a9f94` (re-habilitar filtro categorías IA), `151b90e` (modelo Recording.hasTranscription), `e22eb74` (BulkTranscriptionModal contador honesto), `80447d5` (handler multi-rec + aria-label) + 1 follow-up con SHAs reales (este canon update).
